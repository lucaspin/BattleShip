...
public class Cell {
    ...
    public Cell(int x, int y) {
        if (x >= 0 && y >= 0) {
            ...
            System.out.println("[BattleShip.Cell.constructor] params must be equal or greater than zero");
        }
    }
    ...
    public void setX(int newX) {
        if (newX >= 0) {
            ...
            System.out.println("[BattleShip.Cell.constructor] param must be equal or greater than 0");
        }
    }
